  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-32">
      <motion.div
        ...
        className="mb-20"
      >
        <p className="text-[11px] font-medium uppercase tracking-[0.25em] text-accent mb-6">Color themes</p>
        <div className="flex flex-col lg:flex-row lg:items-end gap-12">
          <div className="flex-1">
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-medium tracking-[-0.05em] leading-[0.9] text-white">Themes for <br /><span className="text-accent">Linux</span></h1>
            <div className="text-6xl sm:text-7xl lg:text-8xl font-medium tracking-[-0.05em] leading-[0.9] text-accent mt-1">
